...
<div class="view view-<?php print $css_name; ?> view-id-<?php print $name; ?> view-display-id-<?php print $display_id; ?> view-dom-id-<?php print $dom_id; ?>">
  <div class="title">
    <?php print theme('textimage_image', 'page_title', $view->display['default']->display_options['title'], array(), 'png', $view->display['default']->display_options['title'], $view->display['default']->display_options['title']);?>
  </div>
